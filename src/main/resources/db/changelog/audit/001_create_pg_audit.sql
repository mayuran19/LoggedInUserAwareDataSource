...
COMMENT ON COLUMN audit.logged_actions.app_session_principal IS 'Logged in user principal';
...
END IF;
    ...
    audit_row = ROW(
        ...
        'f',                                             -- statement_only
        current_setting('app.session.principal', true)   -- logged in user principal
        );
